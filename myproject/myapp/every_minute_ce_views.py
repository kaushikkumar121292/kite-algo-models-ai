...
from .model_every_minute_ce import train_model  # Adjust the import based on your file structure
from .model_every_minute_ce import predict_unseen

class TrainModelViewCE(APIView):
    def get(self, request, *args, **kwargs):
        result = train_model()
        return Response(result)


class PredictViewCE(APIView):
